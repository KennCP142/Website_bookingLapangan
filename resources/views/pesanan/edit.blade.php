    ...
    <div class="col-md-8 offset-md-2">
        ...
        <form action="{{ route('pesanan.update', $pesanan->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nama_pemesan') is-invalid @enderror" id="nama_pemesan" name="nama_pemesan" value="{{ old('nama_pemesan', $pesanan->nama_pemesan) }}">
                @error('nama_pemesan')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('wa_pemesan') is-invalid @enderror" id="wa_pemesan" name="wa_pemesan" value="{{ old('wa_pemesan', $pesanan->wa_pemesan) }}">
                @error('wa_pemesan')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal" name="tanggal" value="{{ old('tanggal', $pesanan->tanggal) }}">
                @error('tanggal')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('jadwal_id') is-invalid @enderror" id="jadwal_id" name="jadwal_id">
                    ...
                    @foreach($jadwals as $jadwal)
                        <option value="{{ $jadwal->id }}" {{ (old('jadwal_id', $pesanan->jadwal_id) == $jadwal->id) ? 'selected' : '' }}>
